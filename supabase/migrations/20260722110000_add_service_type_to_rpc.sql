...
GRANT EXECUTE ON FUNCTION public.submit_public_budget_form(text, text, text, text, text, text, date, time without time zone, integer, text, text) TO anon, authenticated;
